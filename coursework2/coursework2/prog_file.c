...
void printHelp( void ) {
    ...
    char *helpText[] = {//----------------------------single line character limit----|
        ...
        "c",
        "lThe input and output paths should NOT contain whitespace. The frequency",
        "lshould be an integer in Hz. The frequency range supported is from 1Hz up to",
        "ljust less than half the sample frequency of the selected input file.",
        "c",
        "c---",
        "c",
        ...
        "carguments. Please consult your doctor before use.",
        "c",
